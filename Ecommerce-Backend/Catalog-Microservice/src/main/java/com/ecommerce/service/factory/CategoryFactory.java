...
public class CategoryFactory {
    ...
    public Category createCategory(CategoryRequest request) {
        ...
        if (request.getParentCategoryId() != null) {
            log.debug(
                    "Fetching parent category with id: {}",
        ...
        Long categoryId =
                mongoSequenceService.getNextSequence("categories");
    ...
    public Category getCategoryById(Long categoryId) {
        log.debug(
                "Fetching category entity with id: {}",
                categoryId
        );
    ...
    public void validateCategoryNameForUpdate(
        ...
        log.debug(
                "Validating category name for update. Category id: {}",
                categoryId
        );
